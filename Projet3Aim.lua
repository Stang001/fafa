...
local Library = loadstring(game:HttpGet("\104\116\116\112\115\58\47\47\114\97\119\46\103\105\116\104\117\98\117\115\101\114\99\111\110\116\101\110\116\46\99\111\109\47\83\116\97\110\103\48\48\49\47\85\105\108\105\98\114\97\114\121\47\109\97\105\110\47\114\101\109\97\107\101\46\108\117\97"))()
...
local Window = Library:CreateWindow("DogeX", Vector2.new(492, 598), Enum.KeyCode.RightShift)
...
AutoDropToggle:AddSlider(1000, 5000, 700000, 1, function(Value)
...
__index = hookmetamethod(game, "__index", function(self, key)
    if self == Mouse and (tostring(key) == "Hit" or tostring(key) == "Target") then
        if PuppywareSettings.Aiming.TargetAim.Enabled then
            ...
            if PuppywareSettings.Aiming.SilentAim.Enabled then
